...
enum EntInd{
    ...
    EntInd_HumanBandit2,
    EntInd_ChaosSlayer,
    EntInd_ChaosSpellweaver,
    EntInd_ChaosStormtrooper,
    EntInd_Hobgoblin2,
    EntInd_GoblinWarrior2,
    EntInd_GoblinSgt2,
    EntInd_GoblinPoisoner2,
    EntInd_GoblinScout2,
    EntInd_HumsnWoodsman,
    EntInd_GoblinPoisoner,
    EntInd_OgreGuard,
    EntInd_GoblinScout,
    EntInd_ChaosSorceror,
    EntInd_ChaosScout,
    EntInd_ChaosWarrior,
    EntInd_ChaosShocktrooper,
    EntInd_ChaosMauler,
    EntInd_Goblin,
    EntInd_GoblinSgt,
    EntInd_Gorgon,
    ...
    EntInd_AirElemental,
    EntInd_DustDevil,
    EntInd_EarthElemental,
    EntInd_FireElemental,
    EntInd_StoneGolem,
    EntInd_WaterElemental,
    EntInd_GiantBoar,
    EntInd_LavaHound,
    EntInd_Wyvern,
    EntInd_DireWolf,
    EntInd_TombRat,
    EntInd_CaveBear,
    EntInd_LargeScorpion,
    EntInd_Darkenbat,
    EntInd_Bear,
    EntInd_Boar,
    EntInd_GiantBat,
    EntInd_GiantRat,
    EntInd_GiantScorpion,
    EntInd_GiantSquid,
    EntInd_Gryphon,
    EntInd_HellHound,
    EntInd_Manticore,
