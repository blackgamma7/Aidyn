...
class WidgetChoiceDia :public WidgetMenu{
    ...
    u16 unkaa;
    u32 unkac;
    WidgetChoiceDia(u16 choices,char *msg,s16 *dims,u16 *dims2,short *dims3,Color32 *colA,Color32 *colB,u32 param_9);
    WidgetChoiceDia(u16 choices,char *msg,u16 param_4,Color32 *colA,Color32 *colB,u32 param_7,u16 param_8,short param_9);
