...
void Ofunc_8009f4e0(SceneData *param_1){
  ...
  if (0 < i) {
    do {
      if ((pbVar3->flag & 2)) {
        guMtxF2L(pbVar3->unkStruct->mfs[0],&pbVar3->unkStruct->mtxs[param_1->perspNormIndex]);
      }
      i--;
      pbVar3++;
    } while (i != 0);
    ...
    case B5INST_MATRIX:
      ...
      if ((pbVar23->flag & 2) == 0) {
        ...
        if ((pbVar23->flag & 0x200) == 0) {
          ...
          guMtxCatF(afStack320,pBVar2->mfs[0],pBVar2->mfs[0]);
        }
        pBVar8 = unkAnimStructB.b2;
        pBVar2->mfs[0][3][2] *= 16.0f;
        pBVar2->mfs[0][3][0] *= 16.0f;
        pBVar2->mfs[0][3][1] *= 16.0f;
        pBVar2->mfs[0][0][0] *= (unkAnimStructB.b2)->dat->scale;
        ...
        guMtxF2L(pBVar2->mfs[0],&unkAnimStructB.b5Trans->unkStruct->mtxs[normInd]);
