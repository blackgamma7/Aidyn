...
void load_cinematic(CinematicEnum param_1,enum_cinematic_switch param_2,undefined4 param_3){
...
ushort some_cinematic_func(rspCom **param_1){
  int iVar1;
  u8 uVar3;
  rspCom *pauVar2;
  ushort uVar4;
  
  uVar4 = (ushort)gGlobals.screenFadeModeSwitch;
  pauVar2 = *param_1;
  ...
  if (gGlobals.cinematic.Bstart == 1) {
    ...
    if ((gGlobals.cinematic.Borg6 != NULL) &&
       (gGlobals.cinematic.AniDat != NULL)) {
      if ((gGlobals.cinematic.AniDat)->aniTime + iVar1) < *(int *)((gGlobals.cinematic.Borg6)->unk0x20 + 0xc) + -1) {
        pauVar2 = cinematic_increment(pauVar2,(s16)iVar1);
        pauVar2 = (rspCom *)cinematic_fade(pauVar2,iVar1);
      }
      else {
  ...
  pauVar2 = debug::func_with_debug_queue(pauVar2,(short)iVar1);
  *param_1 = pauVar2;
  return uVar4;
}
...
void clear_cinematic_borgs(void){
  ...
  if (gGlobals.cinematic.AniDat != NULL) {AllocFreeQueueItem(&gGlobals.QueueA,&gGlobals.cinematic,1,0);}
  if (gGlobals.cinematic.BGM != NULL) {
...
short cinematic_muteMusic_getName(void){
  u16 uVar1;
  char acStack272 [256];
  ...
  if ((gGlobals.Party != NULL) && ((gGlobals.Party)->Party[0] != NULL)) {
...
rspCom * cinematic_increment(rspCom *param_1,s16 param_2){
  rspCom *pauVar1;
  ...
  if (gGlobals.cinematic.borg6enums[gGlobals.cinematic.tally] == 0) {gGlobals.cinematic.Bstart = 0;}
    ...
    if (gGlobals.cinematic.borg12enums[gGlobals.cinematic.tally] != ~Tacet) {
      ...
      DCM_func(&gGlobals.cinematic.unk0x2c,&gGlobals.cinematic.some_cinematic_tally,
               (void *)((int)(gGlobals.cinematic.BGM)->unk0x8 + 8),0xff,0x80,1,0xffffffff,0);
      ...
      V = (byte)(int)fVar2;
      if (((int)fVar2 & 0xffU) < ((int)fVar1 & 0xffU)) {V = (byte)(int)fVar1;}
      some_music_func((uint)gGlobals.cinematic.unk0x2c,gGlobals.cinematic.some_cinematic_tally,V);
    }
    gGlobals.cinematic.Borg6 = get_borg_6(gGlobals.cinematic.borg6enums[gGlobals.cinematic.tally]);
    gGlobals.cinematic.AniDat = BorgAnimLoadScene(*(uint *)(gGlobals.cinematic.Borg6)->unk0x20);
...
u16 load_world_map(void){
  ...
  if (uVar2 != 0) {
    ...
    do { //look for "opening cutscene" object
      if ((*(short *)&puVar4[-1].unk0x32 == 9) && (puVar4->borg_13 == 0x362)) {
        pdVar5 = puVar4;
      }
      iVar3 = iVar4 >> 0x10;
...
u16 Alaron_truename(void){
  ...
  if (pCVar1 != NULL) {pCVar1->EXP->flags |= TrueName;}
  return 1;
}
...
rspCom * cinematic_fade(rspCom *param_1,short param_2){
  ...
  uVar5 = (uint)cinematicFadePointer->fadeTime * 2;
...
LAB_8005d1d4:
  if (cinematic_fade_short != 0) {
    uVar6 = (uint)cinematic_fade_short;
    cinematic_fade_short = (ushort)(uVar6 - uVar7);
    if ((int)((uVar6 - uVar7) * 0x10000) < 0) {cinematic_fade_short = 0;}
    ...
    if (fVar8 < INT_MAX_f) {cinematic_fade_color.A = (byte)(int)fVar8;}
    else {cinematic_fade_color.A = (byte)(int)(fVar8 - INT_MAX_f);}
...
widgetStruct * Ofunc_8005d330(char *param_1,short param_2,ushort param_3,ushort param_4,ushort param_5,
              ushort param_6,u8 param_7,u8 param_8,u8 param_9,u8 param_10){
  widgetStruct *pwVar1;
  
  pwVar1 = (widgetStruct *)passToMalloc(0x7c);
  pwVar1 = widgettext_func_2(pwVar1,param_1,param_2);
  ...
  (*(pwVar1->methods->SetColor).func)
            ((int)&pwVar1->ptr0 + (int)(short)(pwVar1->methods->SetColor).arg[0],param_7,param_8,
             param_9,param_10);
  return pwVar1;
}
