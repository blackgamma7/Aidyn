...
WidgetGameStateCheats::WidgetGameStateCheats():WidgetMenu(){
  ...
  ScrollA = Utilities::AddScrollMenu(this,0xc,0x14,0x14,0x14,0x14,200,200,0xff,0xff,0xff,0xff,0);
  ScrollC = Utilities::AddScrollMenu(this,0xc,0xdc,0x14,0xdc,0x14,0x104,200,0xff,0xff,0xff,0xff,0);
  ScrollB = Utilities::AddScrollMenu(this,0xc,0x10e,0x14,0x10e,0x14,SCREEN_WIDTH,200,0xff,0xff,0xff,0xff,0);
  for(u8 i=0;i<12;i++) {
    char* txt;
