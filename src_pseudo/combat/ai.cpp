...
bool some_combat_leader_check(ItemID param_1){
  ...
  if ((combatPointer->leaderDead) ||(!CombatEnt_flag_1((&combatPointer->combatEnts)[combatPointer->leaderIndex])))
    {lVar9 = ((int)lVar9 + -4) * 0x1000000 >> 0x18);}
  cVar7 = (char)lVar9 + 1;
...
byte ai_aspect_morale_stam(CombatEntity *param_1,bool param_2){
  Temp_enchant *pTVar1;
  bool bVar4;
  int iVar3;
  longlong lVar2;
  ...
  iVar3 = ;
  if (getModdedStat(param_1->CharSheet->Stats,STAM)==0) {lVar8 = ((lVar8 + -1) * 0x1000000 >> 0x18);}
  ...
  lVar8 = (longlong)(((int)lVar8 + -1) * 0x1000000 >> 0x18);
LAB_8006024c:
  if (combatPointer->playersAlive < combatPointer->playerCount >> 1) {
    lVar8 = (longlong)(((int)lVar8 + 2) * 0x1000000 >> 0x18);
  }
...
LAB_800602cc:
      ...
      if ((&combatPointer->combatEnts)[cVar5] == NULL) {
        ...
        if (getModdedStat((&combatPointer->combatEnts)[cVar5]->CharSheet->Stats,STAM)) {
          lVar8 = (longlong)(((int)lVar8 + 3) * 0x1000000 >> 0x18);
          goto LAB_800602cc;
        }
        iVar4 = param_1->combat_ai_pointer;
      }
...
bool ai_stam_or_enemy_count(CombatEntity *param_1){
  ...
  if ((param_1->combat_ai_pointer->flags & 2) == 0) {
    if (getModdedStat(param_1->CharSheet->Stats,STAM) < 1) {bVar2 = true;}
    else {
...
byte spell_priority_caseSwitch(combat_ai *param_1,SpellEnum param_2)
...
switchD_80060678_caseD_10:
  ...
  case dispelStar:
    ...
    if (combatPointer->EntCount != 0) {
      iVar7 = 0;
      do {
        pCVar1 = *(CombatEntity **)((int)&combatPointer->combatEnts + iVar7);
        ...
        if (*(int *)((int)pCVar3->substruct2[1].arrayA + iVar7) != 0) {
          ...
          iVar7 = 0;
          do {
            iVar8 = *(Temp_enchant **)((int)pCVar2->effects->list + iVar7);
            cVar11 = cVar8;
            if ((((iVar8 != NULL) && (iVar8->school == MVar12)) &&
                (iVar8->timer != 0xffffffff)) &&
               (cVar11 = cVar8 + -1, iVar8->unk0x4 == (uint)(bVar4 == bVar5))) {
              cVar11 = cVar8 + '\x01';
            }
            cVar8 = cVar11;
            uVar9++;
...
void func_800609bc(combat_ai *param_1){
  ...
  combat_aiscores_clear((uint)bVar1);
  if (bVar1 != 0) {
    do {
...
void func_80060a88(combat_ai *param_1){
  ...
  combat_aiscores_clear((uint)bVar1 * (uint)bVar1 * 4 & 0xfffc);
  uVar20 = (ulonglong)(uint)get_combatEnt_x_f(param_1->combatEnt);
  uVar19 = (ulonglong)(uint)get_combatEnt_y_f(param_1->combatEnt);
  ...
  if (iVar16 <= iVar10) {
    do {
      ...
      while (iVar12 <= X + uVar17)) {
        ...
        if ((uVar6 <= bVar1) &&
           (lVar5 = func_80070fa0(pcVar11,iVar12,iVar16,(uint)bVar2), lVar5 != 0)) {
...
LAB_80060cb0:
  ...
  func_800713fc(pcVar11,X,Y,(uint)bVar2);
...
void func_80060db0(combat_ai *param_1){
  ...
  combat_aiscores_clear((uint)bVar1 * (uint)bVar1 * 4 & 0xfffc);
  bVar11 = 0;
  uVar22 = (ulonglong)(uint)get_combatEnt_x_f(param_1->combatEnt);
  uVar21 = (ulonglong)(uint)get_combatEnt_y_f(param_1->combatEnt);
  X = get_combatEnt_x(param_1->combatEnt);
  Y = get_combatEnt_y(param_1->combatEnt);
  ...
  x = (undefined4)uVar22;
  y = (undefined4)uVar21;
  iVar18 = (int)(((int)(char)Y - uVar7) * 0x1000000) >> 0x18;
  iVar13 = (int)(char)Y + uVar7;
  pcVar19 = (combat_aiscore *)0x0;
  if (iVar18 <= iVar13) {
    do {
      feildy = (byte)iVar18;
      iVar17 = (int)(((int)(char)X - uVar7) * 0x1000000) >> 0x18;
      while (iVar17 <= X + uVar7)) {
        feildx = (byte)iVar17;
        sVar8 = sub_square_add_sqrt(feildx,feildy,X,Y);
        if ((sVar8 <= uVar7) &&
           (lVar6 = func_80070fa0(pcVar14,iVar17,iVar18,(uint)bVar1), lVar6 != 0)) {
          ...
          if ((pCVar5->substruct2[0].arrayBCount != 0) && (uVar15 = 0, combatPointer->EntCount != 0)) {
            iVar17 = 0;
            do {
              feild4 = *(CombatEntity **)((int)&combatPointer->combatEnts + iVar17);
              if (*(int *)((int)X_00->arrayA + iVar17) != 0) {
                bVar4 = false;
                ...
                if (bVar4) {
                  ...
                  pcVar19->y = feildy;
                  pcVar19->spell_pri = (byte)lVar6;
                }
                else {
                  set_combat_aiscore(feildx,feildy,0,(byte)lVar6,feild4);
                }
              }
LAB_800610b8:
              uVar15++;
        ...
        iVar17 = (int)(char)(feildx + 1);
      }
      x = (undefined4)uVar22;
      y = (undefined4)uVar21;
      iVar18 = (int)(char)(feildy + 1);
    } while (iVar18 <= iVar13);
  }
  func_800713fc(pcVar14,X,Y,(uint)bVar1);
  set_combatEnt_x_y(param_1->combatEnt,x,y);
  clear_combat_substruc2(X_00);
  return;
}

int fireball_func(combat_ai *param_1){
  CombatEntity *pCVar1;
  ...
  if (combatPointer->EntCount != 0) {
    ...
    do {
      ...
      fVar11 = (float)uVar16;
      if (bVar4) {
        uVar16 = (ulonglong)(uint)(fVar11 + get_combatEnt_x_f(pCVar1));
        uVar12 = (ulonglong)(uint)(fVar13 + get_combatEnt_y_f(pCVar1));
        uVar14 = (ulonglong)(uint)(fVar15 + (float)uVar17);
      }
      fVar13 = (float)uVar12;
      fVar11 = (float)uVar16;
      fVar15 = (float)uVar14;
...

{
  ...
  if (bVar1 == 0) {uStack116 = ai_spell_stam(param_1);}
    ...
    uStack116 = 0;
    uVar24 = (ulonglong)(uint)get_combatEnt_x_f(param_1->combatEnt);
    uVar23 = (ulonglong)(uint)get_combatEnt_y_f(param_1->combatEnt);
    X = get_combatEnt_x(param_1->combatEnt);
    Y = get_combatEnt_y(param_1->combatEnt);
    ...
    uVar8 = (uint)param_1->combatEnt->unk0x23;
    bVar2 = pCVar4->currSpell;
    bVar3 = pCVar4->spellSwitch;
    combat_aiscores_clear(((uint)bVar1 * (uint)bVar1 * 4 & 0x1ffc) << 3);
    ...
    do {
      ...
      if (pSVar9[uStack96] != NONE) {
        ...
        if (uStack116 == 0) 
          {uStack116 = getModdedStat(pCVar4->Stats,STAM) < spell_stamina_subtract(pTVar11,spellPri) ^ 1;}
        uVar20 = (uint)bVar1;
        iVar12 = (int)(char)Y - uVar20;
        iVar13 = (int)(char)Y + uVar20;
        if (iVar12 <= iVar13) {
          iVar21 = (int)(char)X + uVar20;
          do {
            iVar17 = iVar12 + 1;
            iVar18 = (int)(char)X - uVar20;
            if (iVar18 <= iVar21) {
              pSVar19 += uStack96;
              do {
                uVar14 = sub_square_add_sqrt((byte)iVar18,(byte)iVar12,X,Y);
                if ((uVar14 <= bVar1) && (lVar7 = func_80070fa0(pcVar16), lVar7 != 0)) {
                  ...
                  if ((pCVar6->substruct2[1].arrayBCount != 0) &&
                    ...
                    set_combat_aiscore((byte)iVar18,(byte)iVar12,(byte)uVar10,
                                       spellPri + cVar19 * '\n' + pTVar11->level,
                                       (&combatPointer->combatEnts)[(byte)pCVar6->substruct2[1].entindex]);
                  }
                }
                iVar18 = iVar18 + 1;
              } while (iVar18 <= iVar21);
...

{
  ...
  bStack77 = 0;
  uVar4 = 0;
  uVar8 = (uint)param_1->combatEnt->move_length;
  X = get_combatEnt_x(param_1->combatEnt);
  Y = get_combatEnt_y(param_1->combatEnt);
  ...
  uVar20 = (int)(((int)(char)Y - uVar8) * 0x1000000) >> 0x18;
  iVar14 = (int)(char)Y + uVar8;
  if (uVar20 <= iVar14) {
    iVar9 = (int)(char)X + uVar8;
    do {
      uVar18 = (int)(((int)(char)X - uVar8) * 0x1000000) >> 0x18;
      if (uVar18 <= iVar9) {
        do {
          uVar11 = 0;
          bVar16 = (byte)(uVar18 & 0xff);
          sVar10 = sub_square_add_sqrt(bVar16,(byte)uVar20,X,Y);
          uVar19 = _uStack80;
          uVar6 = uStack76_00;
          uVar3 = uVar4;
          if ((uVar8 < sVar10) ||(func_80070fa0(pcVar15,uVar18,uVar20,(uint)bVar1) == 0)) {
LAB_80061b18:
            uStack76_00 = uVar6;
            _uStack80 = uVar19;
            uVar4 = uVar3;
  ...
  pcVar5->y = uStack76;
  func_800713fc(pcVar15,X,Y,(uint)bVar1);
  clear_combat_substruc2(pcVar17);
  return;
}

byte func_80061bc8(combat_ai *param_1,byte param_2,byte param_3,byte param_4,int param_5,byte param_6){
  CombatEntity *pCVar1;
  byte bVar2;
  ushort uVar3;
  uint uVar8;
...
void func_80061d10(combat_ai *param_1,undefined4 param_2){
  int iVar1;
  short sVar2;
  byte bVar3;
  byte *pbVar4;
  ...
  if (combat_AiScore_tally != 0) {
    ...
    do {
      ...
      *pbVar4 = (byte)sVar2;
      if (bVar6 != 0) {
        bVar3 = func_80061bc8(param_1,pbVar4[1],pbVar4[2],(byte)sVar2,param_2,bVar6);
        *pbVar4 = bVar3;
      }
      uVar5++;
      iVar1 = uVar5 << 3;
...
void func_80061dfc(combat_ai *param_1){
  ...
  X_00 = combatPointer->substruct2;
  uVar7 = (uint)param_1->combatEnt->unk0x23;
  func_800714d0();
  y_00 = (undefined4)uVar21;
  x_00 = (undefined4)uVar22;
  uVar16 = 0;
  if (combat_AiScore_tally != 0) {
    do {
      pcVar19 = combat_AiScores_pointer + uVar16;
      uStack104._3_1_ = pcVar19->x;
      uStack104 = (uint)(byte)uStack104;
      uStack100._3_1_ = pcVar19->y;
      pCVar3 = pcVar19->combatEnt;
      uStack100 = (uint)(byte)uStack100;
      x = get_combatEnt_x(pCVar3);
      y = get_combatEnt_y(pCVar3);
      uVar14 = (uint)pCVar3->unk0x23;
      uVar18 = (int)(((int)(char)y - uVar7) * 0x1000000) >> 0x18;
      pCVar4 = pCVar3->CharSheet;
      bVar2 = pCVar3->index;
      pTVar5 = pCVar4->weapons;
      if ((int)uVar18 <= (int)((int)(char)y + (uint)pCVar3->unk0x23)) {
        do {
          uVar15 = (int)(((int)(char)x - uVar7) * 0x1000000) >> 0x18;
          if ((int)uVar15 <= (int)((int)(char)x + uVar14)) {
            ...
            do {
              ...
              if (func_80070fa0(pcVar13,uVar15,uVar18,uVar7) != 0) {
                ...
                if (X_00->arrayA[bVar2] != 0) {
                  ...
                  if (bVar1 != 0) {
                    uVar17 = SEXT18(func_80061bc8(param_1,uVar11,uVar18,(byte)uVar17,0,bVar1););
                  }
                  if (pcVar19->spell_pri < uVar17) {
                    pcVar19->spell_pri = (byte)uVar17;
              ...
              uVar15 = iVar8 >> 0x18;
            } while ((int)uVar15 <= (int)((int)(char)x + (uint)pCVar3->unk0x23));
          }
          uVar14 = (uint)pCVar3->unk0x23;
          uVar18 = SEXT14((char)((u8)uVar18 + 1));
        } while ((int)uVar18 <= (int)((int)(char)y + uVar14));
      }
      y_00 = (undefined4)uVar21;
      x_00 = (undefined4)uVar22;
      pcVar19->x = (byte)uStack104;
      pcVar19->y = (byte)uStack100;
      uVar16++;
  ...
  if (!func_80068358(param_1->combatEnt)) {
    ...
    if (param_1->combatEnt->AtkType == 1) {
      ...
      if (combat_AiScore_tally == 0) {
        ...
        func_80061d10(param_1,(uint)bVar2);
...
void combatAI_run_cmd(combat_ai *param_1,byte *param_2,byte *param_3){
  CharSheet *pCVar1;
  CombatEntity *pCVar2;
  ...
  param_1->entIndex = -1;
  if (pcVar3->combatEnt != NULL) {param_1->entIndex = pcVar3->combatEnt->index;}
  bVar5 = pcVar3->unk0x3;
  if (bVar5 != 0) {
    pcVar3->unk0x3 = bVar5 - 1;
    pCVar1 = param_1->combatEnt->CharSheet;
    pCVar1->currSpell = BYTE_ARRAY_800ef6e0[(byte)(bVar5 - 1)];
  ...
  *param_3 = pcVar3->y;
  ...
  if (((param_1->combatEnt->index == gGlobals.ShadowIndex) &&
      (HasHornOfKynon())) &&
     (pCVar2 = combatPointer->combatEnts, pCVar2 != NULL)) {
...

{
  ...
  if ((pTVar6 != NULL) && (GetIDIndex(pTVar6->id) == fireball)) {
    uVar14 = (uint)pTVar6->range * check_spell_wizard(pCVar1,pTVar6);
    ...
    if ((int)uVar19 <= iVar7) {
      do {
        Y = (byte)uVar19;
        iVar20 = (int)(char)bVar9 - uVar14;
        while( true ) {
          uVar3 = iVar20 * 0x1000000 >> 0x18;
          if ((int)((int)(char)bVar9 + uVar14) < (int)uVar3) break;
          bVar11 = func_80070ee4(pcVar13,(char)((uint)(iVar20 * 0x1000000) >> 0x18),Y,1);
          iVar20 = uVar3 + 1;
          if (bVar11 == false) {
            sVar8 = sub_square_add_sqrt(bVar9,uVar10,(byte)(uVar3 & 0xff),Y);
            pCVar5 = combatPointer;
            if (sVar8 <= (int)uVar14) {
              ...
              if (pCVar4->substruct2[1].arrayBCount != 0) {
                ...
                if (combatPointer->EntCount != 0) {
                  iVar15 = 0;
                  do {
                    if (*(int *)((int)pcVar2[1].arrayA + iVar15) != 0) {
...
void func_80062c04(Vec2 *param_1,float param_2,Vec2 *param_3,Vec2 *param_4,Vec2 *param_5){
  ...
  if (((*param_1)[0] == (*param_3)[0]) && ((*param_1)[1] == (*param_3)[1])) {
    ...
    Vec2_Sub((Vec2 *)&fStack176,param_3,param_1);
    Vec2_Sub((Vec2 *)&fStack112,param_4,param_3);
    ...
    multiVec2((Vec2 *)&fStack112,fVar2);
    pafVar1 = (Vec2 *)&fStack112;
  }
  vec2_sum(param_5,pafVar1,param_3);
  return;
}

bool func_80062e14(uint param_1,uint param_2,byte *param_3,byte *param_4,undefined param_5)
    ...
    if (param_1->unk0x12 < param_1->unk0x13) {
      ...
      do {
        ...
        if (func_80070fa0(pcVar10,bStack336[2]) == 0) {
          bVar2 = true;
          bVar6 = func_80062e14((uint)bStack336[0],(uint)bStack336[1],bStack336 + 2,bStack336 + 3,param_1->combatEnt->unk0x23);
          if (bVar6 == false) break;
        }
        if (func_8007102c(pcVar10,bStack336[0],bStack336[1],bStack336[2],bStack336[3]) == false) {
          bVar2 = true;
          bVar6 = func_80062e14((uint)bStack336[0],(uint)bStack336[1],bStack336 + 2,bStack336 + 3,
        ...
        if ((ushort)param_1->combatEnt->move_length < (uVar5 & 0xff)) {
          setVec2((Vec2 *)afStack328,(float)(uint)bStack336[0],(float)(uint)bStack336[1]);
          setVec2((Vec2 *)afStack264,(float)(uint)bStack336[2],(float)(uint)bStack336[3]);
          bVar2 = true;
          x = get_combatEnt_z_f(param_1->combatEnt);
          y = get_combatEnt_f3_f(param_1->combatEnt);
          setVec2((Vec2 *)afStack200,x,y);
          lVar4 = (longlong)(int)fStack136;
          func_80062c04((Vec2 *)afStack200,(float)(uint)param_1->combatEnt->move_length,
                       (Vec2 *)afStack328,(Vec2 *)afStack264,fStack136);
          if (lVar4 == 0) break;
          if ((float)uVar12 < fStack136[0]) {bStack336[2] = (byte)(int)((double)fStack136[0] + dVar11);}
          else {bStack336[2] = -(char)(int)(dVar11 - (double)fStack136[0]);}
          if ((float)uVar12 < fStack136[1]) {bStack336[3] = (byte)(int)((double)fStack136[1] + dVar11);}
          else {bStack336[3] = -(char)(int)(dVar11 - (double)fStack136[1]);}
        }
        ...
        SetPlayerToMoveQueue(ppVar1,(float)(uint)bStack336[2],(float)(uint)bStack336[3],ppVar1->scale_floatB);
        ...
        if (((int)(uint)param_1->unk0x13 <= (int)(char)bVar7) || (bVar2)) break;
      } while( true );
    }
    func_800713fc(pcVar10,bStack336[0],bStack336[1],(uint)param_1->combatEnt->unk0x23);
    if (bVar3) {
      set_combatEnt_x_y(param_1->combatEnt,(float)(uint)bStack336[0],(float)(uint)bStack336[1]);
...

{
  ...
  bVar5 = false;
  if ((param_1->unk0x4 == '\0') &&
     (param_1->combatEnt->AtkType = 1, pTVar2 != NULL)) {
  ...
  if ((((cVar4 == '\x01') && (param_1->combatEnt->AtkType = 2, pTVar2 != NULL)) &&
      (pTVar2->range == 0)) &&
...
void combat_ai_shadow(combat_ai *param_1){
  ...
  if ((param_1->combatEnt->move_length != 1) && (gGlobals.ShadowIndex != -1)) {
    pCVar1 = (&combatPointer->combatEnts)[(byte)gGlobals.ShadowIndex];
    x = get_combatEnt_x_f(pCVar1);
    y = get_combatEnt_y_f(pCVar1);
    setVec2((Vec2 *)afStack176,x,y);
    iVar4 = (CombatStruct *)(&combatPointer->unk0x0 + (char)param_1->unk0x12 * 2);
    setVec2((Vec2 *)afStack304,(float)(int)(char)iVar4->unk0x5320,
            (float)(int)(char)iVar4->unk0x5321);
    uVar6 = (int)(char)param_1->unk0x12 + 1;
    if (uVar6 < param_1->unk0x13) {
      ...
      do {
        ...
        lVar2 = (longlong)(int)fStack112;
        func_80062c04((Vec2 *)afStack176,10.0,(Vec2 *)afStack304,(Vec2 *)afStack240,fStack112);
        if (lVar2 != 0) {
          param_1->unk0x13 = (char)uVar6 + 1;
          if ((float)uVar8 < fStack112[0]) {
            (&combatPointer->unk0x5320)[iVar5] = (byte)(int)((double)fStack112[0] + dVar7);
          }
          else {
            (&combatPointer->unk0x5320)[iVar5] = -(char)(int)(dVar7 - (double)fStack112[0]);
          }
          if (fStack112[1] <= (float)uVar8) {
            (&combatPointer->unk0x5321)[iVar5] = -(char)(int)(dVar7 - (double)fStack112[1]);
            return;
          }
          (&combatPointer->unk0x5321)[iVar5] = (byte)(int)((double)fStack112[1] + dVar7);
          return;
        }
        copyVec2((Vec2 *)afStack240,(Vec2 *)afStack304);
        iVar5+=2;
        uVar6++;
...
bool func_80063af4(combat_ai *param_1,undefined1 param_2,undefined1 param_3){
  bool bVar1;
  ...
  param_1->unk0x13 = func_80071ec4(&combatPointer->substruct,get_combatEnt_x(param_1->combatEnt),get_combatEnt_y(param_1->combatEnt),
   param_2,param_3,param_1->combatEnt->unk0x23,(byte (*) [2])&combatPointer->unk0x5320);
...
bool func_80063c94(combat_ai *param_1){
  ...
  if ((param_1->entIndex != -1) &&
     (pCVar1 = (&combatPointer->combatEnts)[param_1->entIndex], pCVar1 != NULL)) {
...
void func_80063db0(combat_ai *param_1,float param_2,float param_3,float param_4,float param_5,
  ...
  setVec2((Vec2 *)afStack176,param_2,param_3);
  setVec2((Vec2 *)afStack112,param_4,param_5);
  Vec2_Sub((Vec2 *)fStack240,(Vec2 *)afStack112,(Vec2 *)afStack176);
  multiVec2((Vec2 *)fStack240,param_6);
  vec2_sum(fStack240,fStack240,(Vec2 *)afStack176);
  ...
  func_800713fc(pcVar3,get_combatEnt_x(param_1->combatEnt),get_combatEnt_y(param_1->combatEnt),(uint)param_1->combatEnt->unk0x23);
  gGlobals.combatBytes[1] = gGlobals.combatBytes[0];
  gGlobals.combatBytes[0] = 5;
  combatPointer->unk0x4fbc = 0xf0;
  return;
...
bool func_80063f1c(combat_ai *param_1,undefined1 param_2,undefined param_3){
  bool bVar1;
  bool bVar2;
...

{
  ...
  pCVar1 = param_1->combatEnt;
  *param_2 = 100000.0f;
  setVec2((Vec2 *)afStack304,get_combatEnt_x_f(pCVar1),get_combatEnt_y_f(pCVar1));
  do {
    ...
    if (prVar2 != NULL) {
      setVec2((Vec2 *)afStack112,(prVar2->header).coords[0],(prVar2->header).coords[2]);
      fVar5 = get_vec2_proximity((Vec2 *)afStack112,(Vec2 *)afStack304);
      if (fVar5 <= *param_2) {
        copyVec2((Vec2 *)afStack112,(Vec2 *)afStack240);
        *param_2 = fVar5;
        prVar4 = prVar2;
      }
    }
...
bool func_800641b8(combat_ai *param_1,undefined4 param_2,undefined4 param_3){
  char cVar1;
  u8 uVar2;
  bool bVar3;
  bool uVar4;
...
bool func_800642c4(combat_ai *param_1,byte *param_2,byte *param_3){
  char cVar1;
  s8 uVar2;
  bool bVar3;
...
void func_80064494(combat_ai *param_1){
  ...
  if (ai_check_entFlag_4(param_1) == 0) {cVar2 = func_800642c4(param_1,uStack24,uStack24 + 1);}
    ...
    setVec2((Vec2 *)&combatPointer->entity_XY,get_combatEnt_x_f(param_1->combatEnt),get_combatEnt_y_f(param_1->combatEnt));
...
void func_800645b4(combat_ai *param_1){
  ...
  if (ai_check_entFlag_4(param_1) == 0) {func_80064714(param_1);}
    ...
    if (!bVar1) {
      setVec2((Vec2 *)afStack96,get_combatEnt_x_f(param_1->combatEnt),get_combatEnt_y_f(param_1->combatEnt));
      fVar7 = get_vec2_proximity((Vec2 *)afStack96,(Vec2 *)&combatPointer->entity_XY);
...
bool elemental_in_combat(void){
  ...
  if (combatPointer->EntCount != 0) {
    do {
      if (((pcVar3->arrayA[0] != 0) && ((&combatPointer->combatEnts)[uVar2] != NULL))
...
bool zombie_in_combat(void){
  ...
  if (combatPointer->EntCount != 0) {
    ...
    do {
      if (((pcVar2->arrayA[0] != 0) && (*ppCVar3 != NULL)) &&
...
bool IsSomeonePoisoned(void){
  ...
  if (combatPointer->EntCount != 0) {
    ...
    do {
      if ((pcVar3->arrayA[0] != 0) && (*ppCVar4 != NULL)) {
        uVar2 = 0;
        peVar1 = (*ppCVar4)->CharSheet->effects;
        do {
          uVar2++;
          if ((peVar1->list[0] != NULL) && (peVar1->list[0]->index == poison)) {
            return true;
          }
...
bool func_80064948(combat_ai *param_1){
  ...
  if (param_1->entIndex != -1){
    if (pcVar3->arrayA[param_1->entIndex] != 0) {
      ...
      func_8007231c(pcVar3,(uint)param_1->entIndex);
      goto LAB_800649cc;
    }
  }
...
byte ai_check_entFlag_4(combat_ai *param_1){
 byte bVar2;
