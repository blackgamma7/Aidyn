...
void * heapAlloc(u32 size,char *file,u32 line){
  ...
  if (size == 0) return NULL;
    ...
    uVar7 = 0xffffffff;
    bVar1 = false;
    pHVar3 = (Heap_block_Debug *)gMemMonitor.memRegionNext;
    ...
    if (pHVar6 == NULL) {
      ...
      assert("heap.cpp",gMemMonitor.text);
    }
...
u32 get_memFree_2(void){
  ...
  if (gMemMonitor.flag != 0) {
    uVar3 = 0;
    pHVar2 = (Heap_block_Debug *)gMemMonitor.memRegionNext;
    if (gMemMonitor.memRegionNext) {
      do {
        uVar1 = get_heap_size(pHVar2);
        if (uVar3 < (uVar1 & ~1)) {
...
void print_mem_allocated(func *param_1,void *param_2){
  ...
  pHVar4 = (Heap_block_Debug *)gMemMonitor.memRegionStart;
  do {
...

{
  ...
  pHVar6 = (Heap_block_Debug *)((s32)param_1 - (uVar3 & ~1));
  uVar8 = uVar1;
  if ((uVar2 & 1) == 0) {
...
void passToFree(void *X){HeapFree(x,FILENAME,0x47e);}