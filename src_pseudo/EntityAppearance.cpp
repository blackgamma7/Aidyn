...
EntityExtra gEntityExtras[]={
 ...
 {(EntInd_Abrecan+1),           0x25c8,             BORG8_PortraitAbrecan,   0.4f,  1.96f, 0.75f, 0.969f},  //0
 ...
 {(EntInd_Ardra+1),             0x2607,             0x010a,                  0.4f,  1.7f,  0.6f,  1.00f},   //3
 {(EntInd_Arturo+1),            0x263d,             0x010b,                  0.5f,  2.01f, 0.8f,  0.952f},  //4
 {(EntInd_Assim+1),             BORG7_Lich,         BORG8_PortraitLich,      0.2f,  2.2f , 0.62f, 1.296f},  //5
 {(EntInd_Baird+1),             0x327b,             0x010c,                  0.53f, 2.09f, 0.85f, 1.00f},   //6
 {(EntInd_BanditBoss+1),        0x26e4,             0x010f,                  0.38f, 1.90f, 0.72f, 0.974f},  //7
 {(EntInd_BanditBoss2+1),       0x26e4,             0x010f,                  0.38f, 1.90f, 0.72f, 1.0227f}, //8
 {(EntInd_BanditBoss3+1),       0x26e4,             0x010f,                  0.38f, 1.90f, 0.72f, 1.1201f}, //9
 {(EntInd_Bear+1),              BORG7_Bear,         BORG8_PortraitBear,      0.59f, 1.22f, 1.0f,  1.107f},  //10
 {(EntInd_Becan+1),             0x271b,             BORG8_PortraitBecan,     0.48f, 2.04f, 0.7f,  0.907f},  //11
 ...
 {(EntInd_ChaosLt+1),           0x2de0,             0x11a,                   0.21f, 1.9f,  0.9f,  1.132f},  //18
 {(EntInd_ChaosMjr+1),          0x2e09,             0x11b,                   0.52f, 4.35f, 1.5f,  0.621f},  //19
 {(EntInd_ChaosMauler+1),       0x2ee1,             0x11d,                   0.49f, 2.43f, 1.0f,  1.25f},   //20
 ...
 {(EntInd_ChaosSlayer+1),       0x2ee1,             0x11d,                   0.49f, 2.43f, 1.0f,  1.0f},    //23
 ...
 {(EntInd_ChaosWarrior+1),      0x2e5b,             0x120,                   0.6f,  1.69f, 0.9f,  1.0f},    //27
 {(EntInd_Charisa+1),           0x279c,             0x121,                   0.4f,  1.7f,  0.5f,  1.0f},    //28
 ...
 {(EntInd_Ehud+1),              0x294a,             0x0134,                  0.37f, 1.44f, 0.65f, 1.111f},  //41
 {(EntInd_Farris+1),            0x275d,             0x0135,                  0.53f, 1.6f,  0.4f,  1.094f},  //42
 ...
 {(EntInd_FireElemental+1),     0x2fba,             0x0136,                  0.62f, 1.9f,  0.75f, 1.316f},  //46
 {(EntInd_Firelord+1),          0x2fba,             0x0136,                  0.62f, 1.9f,  0.75f, 1.316f},  //47
 {(EntInd_Gabrion+1),           0x2978,             0x0138,                  0.4f,  1.7f,  0.5f,  1.059f},  //48
 {(EntInd_Gechina+1),           0x29a8,             0x013c,                  0.4f,  1.32f, 0.4f,  1.0f},    //49
 ...
 {(EntInd_GiantGolem+1),        0x3009,             0x0139,                  0.6f,  2.41f, 0.85f, 1.25f},   //52
 {(EntInd_GiantRat+1),          BORG7_Rat,          BORG8_PortraitRat,       0.23f, 0.74f, 1.0f,  1.0f},    //53
 {(EntInd_GiantScorpion+1),     0x3347,             0x0168,                  0.49f, 0.33f, 0.3f,  4.545f},  //54
 {(EntInd_GiantSkeleton+1),     0x336a,             0x016c,                  0.55f, 1.58f, 0.6f,  1.8f},    //55
 {(EntInd_GiantSquid+1),        0x337a,             0x016e,                  0.4f,  4.6f,  1.3f,  1.0f},    //56
 {(EntInd_Goblin+1),            BORG7_Goblin,       0x013e,                  0.5f,  0.74f, 1.0f,  1.0f},    //57
 {(EntInd_GoblinPoisoner+1),    BORG7_Goblin2,      0x013f,                  0.42f, 1.72f, 0.5f,  0.9f},    //58
 {(EntInd_GoblinPoisoner2+1),   BORG7_Goblin2,      0x013f,                  0.42f, 1.72f, 0.5f,  1.0f},    //59
 {(EntInd_GoblinScout+1),       BORG7_Goblin,       0x013e,                  0.5f,  1.7f,  0.5f,  0.9f},    //60
 {(EntInd_GoblinScout2+1),      BORG7_Goblin,       0x013e,                  0.5f,  1.7f,  0.5f,  1.0f},    //61
 {(EntInd_GoblinSgt2+1),        BORG7_Goblin2,      0x013f,                  0.42f, 1.72f, 0.5f,  1.2f},    //62
 {(EntInd_GoblinSgt+1),         BORG7_Goblin2,      0x013f,                  0.42f, 1.72f, 0.5f,  1.0f},    //63
 {(EntInd_GoblinWarrior2+1),    BORG7_Goblin,       0x013f,                  0.5f,  1.7f,  0.5f,  1.2f},    //64
 {(EntInd_Godric+1),            0x2a1f,             0x0140,                  0.22f, 1.69f, 0.5f,  1.0f},    //65
 {(EntInd_Golnar+1),            BORG7_Lich,         BORG8_PortraitLich,      0.2f,  2.2f,  0.62f, 1.21f},   //66
 {(EntInd_Gorgon+1),            0x3066,             0x0141,                  0.37f, 2.21f, 0.7f,  1.0f},    //67
 {(EntInd_Gotzone+1),           0x2a43,             0x0142,                  0.4f,  1.38f, 0.4f,  1.0f},    //68
 {(EntInd_Gryphon+1),           0x3094,             0x0143,                  0.38f, 1.4f,  1.3f,  1.0f},    //69
 {(EntInd_Guard1+1),            0x2a58,             0x0144,                  0.4f,  1.85f, 0.6f,  0.973f},  //70
 {(EntInd_Guard2+1),            0x2a82,             0x0145,                  0.4f,  1.85f, 0.6f,  0.973f},  //71
 {(EntInd_Guard3+1),            0x2aae,             0x0146,                  0.4f,  1.85f, 0.5f,  0.973f},  //72
 {(EntInd_Harpy+1),             0x30c5,             0x0147,                  0.25f, 2.5f,  1.1f,  1.0f},    //73
 {(EntInd_HellHound+1),         0x30f1,             0x0148,                  0.35f, 1.1f,  0.9f,  1.0f},    //74
 ...
 {(EntInd_HumanBandit+1),       0x26ac,             0x014b,                  0.38f, 1.93f, 0.7f,  0.993f},  //77
 {(EntInd_HumanBandit2+1),      0x26ac,             0x014b,                  0.38f, 1.93f, 0.7f,  1.0263f}, //78
 {(EntInd_HumanBandit3+1),      0x26ac,             0x014b,                  0.38f, 1.93f, 0.7f,  1.1196f}, //79
 {(EntInd_HumanWoodsman+1),     0x26e4,             0x010f,                  0.38f, 1.93f, 0.75f, 0.84f},   //80
 ...
 {(EntInd_Jundarguard+1),       0x2ad3,             0x014d,                  0.4f,  2.1f,  0.45f, 1.048f},  //83
 {(EntInd_Keelin+1),            0x2b29,             0x014f,                  0.64f, 1.9f,  0.65f, 0.895f},  //84
 ...
 {(EntInd_LargeScorpion+1),     0x3347,             0x0168,                  0.49f, 0.33f, 0.3f,  2.424f},  //87
 {(EntInd_LavaHound+1),         0x30f1,             0x0148,                  0.35f, 1.1f,  0.9f,  1.4f},    //88
 {(EntInd_LizardMan+1),         0x3176,             0x0151,                  0.47f, 2.2f,  0.9f,  1.0f},    //89
 {(EntInd_LizardManBoss+1),     0x31a2,             0x0152,                  0.4f,  2.74f, 1.0f,  1.0f},    //90
 {(EntInd_LizardManSgt+1),      0x31c8,             0x0153,                  0.26f, 2.34f, 0.9f,  1.0f},    //91
 {(EntInd_Lloyd+1),             0x2918,             0x0131,                  0.4f,  1.9f,  0.6f,  0.947f},  //92
 {(EntInd_Lugash+1),            0x2db7,             0x0117,                  0.57f, 2.59f, 0.75f, 1.0f},    //93
 ...
 {(EntInd_Manticore+1),         0x31fe,             0x0156,                  0.35f, 1.8f,  1.7f,  1.0f},    //97
 {(EntInd_Marquis+1),           0x2b75,             0x0157,                  0.6f,  2.19f, 0.65f, 0.89f},   //98
 {(EntInd_Mehrdad+1),           BORG7_Lich,         BORG8_PortraitLich,      0.2f,  2.2f,  0.62f, 1.2528f}, //99
 {(EntInd_Minotuar+1),          0x3224,             0x3846,                  0.25f, 1.9f,  0.75f, 1.079f},  //100
 {(EntInd_MinotuarLord+1),      0x3224,             0x0159,                  0.25f, 1.9f,  0.75f, 1.4027f}, //101
 {(EntInd_MirariFemale+1),      BORG7_MirariFemale, 0x015a,                  0.4f,  1.18f, 0.4f,  1.0f},    //102
 {(EntInd_MirariMale+1),        BORG7_MirariMale,   0x015b,                  0.4f,  1.3f,  0.4f,  1.0f},    //103
 {(EntInd_Nasim+1),             BORG7_Lich,         BORG8_PortraitLich,      0.2f,  2.2f,  0.62f, 0.9504f}, //104
 {(EntInd_Niesen+1),            0x2bb3,             0x015d,                  0.53f, 1.82f, 0.6f,  0.934f},  //105
 {(EntInd_NightBoss1+1),        0x26e4,             0x010f,                  0.38f, 1.9f,  0.75f, 0.974f},  //106
 {(EntInd_NightBoss2+1),        0x26e4,             0x010f,                  0.38f, 1.9f,  0.75f, 1.0714f}, //107
 {(EntInd_NightBoss3+1),        0x26e4,             0x010f,                  0.38f, 1.9f,  0.75f, 1.1688f}, //108
 {(EntInd_Ogre+1),              BORG7_Ogre,         0x015e,                  0.5f,  2.62f, 1.4f,  1.0f},    //109
 {(EntInd_OrgeBoss+1),          0x3276,             0x015f,                  0.55f, 2.96f, 1.5f,  1.0f},    //110
 {(EntInd_OgreGuard+1),         BORG7_Ogre,         0x015e,                  0.5f,  2.62f, 1.4f,  1.2f},    //111
 {(EntInd_Oriana+1),            0x2bd7,             0x0160,                  0.4f,  1.68f, 0.5f,  1.0f},    //112
 {(EntInd_Pandara+1),           0x2be3,             0x0161,                  0.4f,  1.9f,  1.0f,  1.0f},    //113
 ...
 {(EntInd_Rooughah+1),          0x1243,             0x0165,                  0.36f, 1.85f, 1.0f,  1.0f},    //117
 {(EntInd_Salamander+1),        0x32f8,             0x0166,                  0.43f, 1.4f,  3.0f,  0.643f},  //118
 {(EntInd_SandWorm+1),          0x3316,             0x0167,                  0.28f, 0.4f,  1.0f,  1.625f},  //119
 {(EntInd_Shadow+1),            0x2c17,             0x0169,                  0.44f, 1.82f, 0.6f,  1.0f},    //120
 {(EntInd_Shatrevar+1),         BORG7_Lich,         BORG8_PortraitLich,      0.2f,  2.2f,  0.62f, 1.1232f}, //121
 {(EntInd_Sheridan+1),          0x2c31,             BORG8_PortraitSheridan,  0.3f,  1.82f, 0.55f, 1.0f},    //122
 {(EntInd_Sholeh+1),            0x2c6a,             0x016b,                  0.35f, 1.88f, 0.65f, 1.064f},  //123
 {(EntInd_Skeleton+1),          0x336a,             0x016c,                  0.55f, 1.58f, 0.6f,  1.0f},    //124
 {(EntInd_GiantArcher+1),       0x336a,             0x016c,                  0.55f, 1.58f, 0.6f,  0.8f},    //125
 {(EntInd_SkeletonUnarmed+1),   0x336a,             0x016c,                  0.55f, 1.58f, 0.6f,  0.8f},    //126
 {(EntInd_SpiritWolf+1),        0x3402,             0x0176,                  0.41f, 0.9f,  0.65f, 1.4f},    //127
 ...
 {(EntInd_STER0903+1),          BORG7_MirariFemale, 0x015a,                  0.4f,  1.18f, 0.4f,  1.0f},    //131
 {(EntInd_STER0904+1),          BORG7_MirariMale,   0x015b,                  0.4f,  1.3f,  0.4f,  1.0f},    //132
 {(EntInd_STER1002+1),          BORG7_MirariMale,   0x015b,                  0.4f,  1.3f,  0.4f,  1.0f},    //133
 {(EntInd_STER1101+1),          BORG7_MirariMale,   0x015b,                  0.4f,  1.3f,  0.4f,  1.0f},    //134
 {(EntInd_STER1202+1),          BORG7_MirariFemale, 0x015a,                  0.4f,  1.18f, 0.4f,  1.0f},    //135
 {(EntInd_STER1203+1),          BORG7_MirariMale,   0x015b,                  0.4f,  1.3f,  0.4f,  1.0f},    //136
 {(EntInd_STER1301+1),          BORG7_MirariFemale, 0x015a,                  0.4f,  1.18f, 0.4f,  1.0f},    //137
 {(EntInd_STER1402+1),          BORG7_MirariFemale, 0x015a,                  0.4f,  1.18f, 0.4f,  1.0f},    //138
 {(EntInd_STER1403+1),          BORG7_MirariFemale, 0x015a,                  0.4f,  1.18f, 0.4f,  1.0f},    //139
 {(EntInd_STER1404+1),          BORG7_MirariFemale, 0x015a,                  0.4f,  1.18f, 0.4f,  1.0f},    //140
 {(EntInd_STER1405+1),          BORG7_MirariFemale, 0x015a,                  0.4f,  1.18f, 0.4f,  1.0f},    //141
 {(EntInd_STER1504+1),          BORG7_MirariMale,   0x015b,                  0.4f,  1.3f,  0.4f,  1.0f},    //142
 {(EntInd_STER1505+1),          BORG7_MirariFemale, 0x015a,                  0.4f,  1.18f, 0.4f,  1.0f},    //143
 {(EntInd_STEU01+1),            BORG7_MirariMale,   0x015b,                  0.4f,  1.3f,  0.4f,  1.0f},    //144
 {(EntInd_STEU02+1),            BORG7_MirariFemale, 0x015a,                  0.4f,  1.18f, 0.4f,  1.0f},    //145
 ...
 {(EntInd_StoneGolem+1),        0x3009,             0x0139,                  0.6f,  2.41f, 0.85f, 1.0f},    //151
 ...
 {(EntInd_STPS08+1),            0x26e4,             0x10f,                   0.4f,  1.85f, 0.72f, 0.956f},  //159
 ...
 {(EntInd_Trahern+1),           0x2c77,             0x0171,                  0.3f,  1.78f, 0.5f,  1.0f},    //205
 {(EntInd_Troll+1),             0x33AD,             0x0172,                  0.59f, 2.6f,  1.7f,  1.0f},    //206
 {(EntInd_Txomin+1),            0x2c83,             0x0173,                  0.4f,  1.38f, 0.4f,  1.0f},    //207
 {(EntInd_WaterElemental+1),    0x2fe1,             0x0174,                  0.61f, 2.69f, 1.1f,  1.0f},    //208
 ...
 {(EntInd_Woodsman2+1),         0x26e4,             0x010f,                  0.38f, 1.93f, 0.72f, 0.933f},  //211
 {(EntInd_Woodsman3+1),         0x26e4,             0x010f,                  0.38f, 1.93f, 0.72f, 1.0263f}, //212
 {(EntInd_Wraith+1),            0x3434,             0x0177,                  0.45f, 1.86f, 0.65f, 1.21f},   //213
 ...
 {(EntInd_Yeraza+1),            0x2ccd,             0x017a,                  0.4f,  1.22f, 0.4f,  1.21f},   //216
 {(EntInd_Yuli+1),              BORG7_MirariMale,   0x017b,                  0.4f,  1.3f,  0.4f,  1.0f},    //217
 {(EntInd_Zaratas+1),           0x2d03,             0x017c,                  0.4f,  2.36f, 0.5f,  1.0f},    //218
 {(EntInd_Zombie+1),            BORG7_Zombie,       0x017d,                  0.33f, 1.76f, 0.75f, 1.0f},    //219
 {(EntInd_Zurene+1),            0x2d27,             0x017e,                  0.4f,  1.16f, 0.4f,  1.0f},    //220
 {0,                            0,                  0,                       0,     0,     0,     0}        //221
};
...
dialougeEntity_Info dailougEnt_info_array[]={
  ...
  {(DiaEntInd_Balfin+1),       0x27e6,              0x010e,                  1.85f, 0.946f}, //2
  ...
  {(DiaEntInd_Damek+1),        0x2831,              0x12a,                   1.7f,  0.853f}, //8
  {(DiaEntInd_Darmath+1),      0x284e,              0x12b,                   2.8f,  1.0f},   //9
  {(DiaEntInd_Devlin+1),       0x2859,              0x12c,                   1.94f, 1.0f},   //10
  {(DiaEntInd_Exponto+1),      BORG7_ship,          BORG8_PortraitNPCMale1,  1.0f,  1.0f},   //11
  ...
  {(DiaEntInd_Fyrsil+1),       0x296d,              0x0137,                  1.65f, 1.0f},   //14
  ...
  {(DiaEntInd_Jundargate+1),   0x0d76,              0x013a,                  1.0f,  1.0f},   //21
  ...
  {(DiaEntInd_Mago+1),         0x2b41,              0x0155,                  1.65f, 0.788f}, //25
