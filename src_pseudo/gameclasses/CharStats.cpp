...
int getBaseStat(CharStats *stats,CHAR_STAT arg1){
  return capStatMax(arg1,(uint)stats->statArray3[arg1],base_stat_cap);
}

int getModdedStat(CharStats *param_1,CHAR_STAT param_2){
  return capStatMax(param_2,param_1->Modded_Stats[param_2],modded_stat_cap);}

int get_stat_trainPrice(CharStats *param_1,CHAR_STAT param_2){
...
int get_base_stat_(CharStats *param_1,CHAR_STAT arg1){
  return capStatMax(arg1,(uint)param_1->Base_Stats[arg1],base_stat_cap);}

int get_moddedStat_difference(CharStats *param_1,CHAR_STAT arg1){
  return (int)(param_1->Modded_Stats[arg1] - param_1->Base_Stats[arg1];
}

int capStatMax(CHAR_STAT arg0,int stat,int *caps){
  int iVar1;
