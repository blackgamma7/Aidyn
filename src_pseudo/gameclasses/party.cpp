...
void Party::CheckFlags(Party *param_1,ItemID param_2,bool alive,bool state){
  ushort uVar1;
  undefined4 uVar2;
  undefined4 uVar3;
  undefined4 uVar4;
...
bool Party::AddMember(Party *param_1,ItemID param_2){
  bool bVar3;
  uint uVar1;
  CharSheet *pCVar2;
  uint uVar4;
...
bool Party::isMemberUnequipped(Party *param_1,u8 slot){
  Entity_Ram *pEVar1;
  byte bVar3;
...
void Party::StripMember(Party *param_1,u8 param_2,u8 param_3){
    ...
    if (param_3) {
      ...
      RemoveShieldFrom(param_1,(uint)param_2);
    }
  }
}
...
bool Party::HasEntity(Party *param_1,CharSheet *param_2){
  uint uVar1;
...
u8 get_equip_error(Party *param_1,u8 param_2,char param_3){
  ...
  pCVar1 = param_1->Members[param_2];
  if ((pCVar1) &&
     (piVar2 = param_1->Inventory->GetItemaEntry,
     puVar4 = (GearInstance *)(*(piVar2->get_inv_slot).func)((s32)param_1->Inventory->inv_slots +
...
bool itemtype_ring(Party *param_1,u8 param_2,GearInstance *param_3,CharSheet *param_4){
...
bool use_scroll(Party *param_1,u8 param_2,GearInstance *param_3,CharSheet *param_4){
  u8 bVar1;
  u8 bVar2;
...
s32 Check_loremaster_INT(CharSheet **param_1){
  ...
  do {
    ...
    if ((pCVar1) && (!isDead(pCVar1))) {
      ...
      if (uVar3 < (uVar2)) {uVar3 = uVar2;}
      uVar8+= (s32)CharSkills::getModdedSkill(pCVar1->Skills,SKILL_LOREMASTER);
    }
    uVar4++;
    param_1++;
  } while (uVar4 < 4);
...
float merchant_skill_check(Party *param_1,u8 MInt,u8 Mstam){
  ...
  do {
    ...
    if ((pCVar1) && (!isDead(pCVar1))) {
      cVar6 = CharSkills::getModdedSkill(pCVar1->Skills,Merchant);
...
bool lockpicking_func(Party *p,byte lock,char *text)
...
char * appraise_price(Party *param_1,ItemID param_2,u32 param_3){
  ...
  do {
    ...
    if (pCVar1) {
      iVar2 = CharStats::getModdedStat(pCVar1->Stats,STAT_INT);
      cVar3 = CharSkills::getModdedSkill(pCVar1->Skills,Merchant);
      uVar4 = iVar2 + cVar3 * 6;
...
u32 check_Merchant_INT(Party *param_1){
  ...
  uVar5 = 0;
  if (cVar4 != -1) {
    uVar5 = (s32)CharSkills::getModdedSkill(param_1->Members[cVar4]->Skills,Merchant);
  }
...
u32 check_ranger(Party *param_1){
  ...
  uVar2 = 0;
  if (cVar3 != -1) {
    uVar2 = (s32)CharSkills::getModdedSkill(param_1->Members[cVar3]->Skills,SKILL_RANGER);
  }
...
u32 check_theif_Int(Party *param_1){
  ...
  if (cVar4 == -1) return 0;
    ...
    pCVar1 = param_1->Members[cVar4];
    iVar2 = CharStats::getModdedStat(pCVar1->Stats,STAT_INT);
    cVar4 = CharSkills::getModdedSkill(pCVar1->Skills,SKILL_THIEF);
...
u32 check_Wizard_int(Party *param_1){
  ...
  if (cVar4 == -1) return 0;
    ...
    pCVar1 = param_1->Members[cVar4];
    iVar2 = CharStats::getModdedStat(pCVar1->Stats,STAT_INT);
    cVar4 = CharSkills::getModdedSkill(pCVar1->Skills,SKILL_WIZARD);
...
bool FUN_800830a4(Party *param_1,byte param_2,GearInstance *param_3,CharSheet *param_4,byte param_5)

{
  ...
  if (uVar9 < param_5) {
    X = create_2ByteArray((byte (*) [2])(param_3->base).statMod);
