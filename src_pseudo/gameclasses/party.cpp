  ...
  if (!bVar4) {
    ...
    uVar3 = (*(piVar2->get_some_bool).func)
                      ((int)param_1->Inventory->inv_slots +
                       (short)(piVar2->get_some_bool).arg[0] + -4,(ulonglong)(ushort)IVar1,1);
    if (uVar3 == 0) {
      if (X != (byte (*) [2])0x0) {Free(X,FILENAME,0x3b2);}
      bVar4 = 1;
    }
    else {
...
void func_8007f508(Temp_weapon *param_1,byte (*param_2) [2],char param_3){
  if (param_1->Stat != (byte (*) [2])0x0) {Free(param_1->Stat,FILENAME,0x552);}
...
bool func_8007f9b8(PartyStruct *param_1,byte param_2,byte param_3){
  ...
  if (pCVar1->pItemList != (CharGear *)0x0) {
    ...
    if (X != (byte (*) [2])0x0) {Free(X,FILENAME,0x625);}
  }
  return true;
}
...
u8 skillcheck_troubador(PartyStruct *arg0){
  ...
  pPVar5 = arg0;
  do {
    if (pPVar5->Party[0] != (CharSheet *)0x0) {
  ...
  if ((uVar7 != 4) && (uVar4 = 0, uVar2 != 0)) {
    if (arg0->Party[uVar7] == (CharSheet *)0x0) {uVar4 = 0;}
    else {
...
u8 healing_widget_AB_func(undefined4 param_1,widgetStruct *param_2){
  PTR_800ed504 = (widgetStruct *)0x0;
  FUN_800b72cc(gGlobals.widgetHandler,param_2);
  if (param_2 != (widgetStruct *)0x0) {
...
void healing_result_widget(char *arg0)
{
  ...
  if (gGlobals.screenFadeModeSwitch == 2) {
    if (combatPointer != (CombatStruct *)0x0) {
      copy_string_to_combat_textbox(combatPointer,arg0,0);
    }
  }
  else {
    col1 = OFFWHITE;
...

{
  ...
  pCVar1 = arg0->Party[A];
  pCVar2 = arg0->Party[B];
  if ((pCVar1 == (CharSheet *)0x0) || (pCVar2 == (CharSheet *)0x0)) {
    ...
    if (uVar4 == (uVar5)) {
      ...
      if (gGlobals.screenFadeModeSwitch == 2) {
        ...
        pCVar9 = pCVar1->Skills;
      }
      else {
        pCVar9 = pCVar1->Skills;
      }
      cVar8 = getModdedSkill(pCVar9,Healer);
...
void herb_func(void){
  ...
  FUN_8002ff30(*(undefined4 *)(puVar1 + 0x80));
}
...
char * party_healing_func(PartyStruct *param_1,uint param_2,uint param_3){
  ...
  pCVar1 = param_1->Party[param_2];
  if ((pCVar1 == (CharSheet *)0x0) ||
     (pCVar2 = param_1->Party[param_3], pCVar2 == (CharSheet *)0x0)) {
  ...
  if (uVar6 == uVar7) {
    ...
    if (uVar8 != 0) {
      if (combatPointer == (CombatStruct *)0x0) {herb_func();}
...
char * some_healing_func(PartyStruct *param_1,u8 param_2,u8 param_3,StatEnum param_4)

{
  ...
  if (someStatCheck(pCVar2->Stats,param_4) == 0) {
    ...
    uVar6 = (*(piVar3->get_some_bool).func)
                      ((int)param_1->Inventory->inv_slots +
                       (short)(piVar3->get_some_bool).arg[0] + -4,(ulonglong)itemID_array[31],1);
    if (uVar6 != 0) {
      herb_func();
      iVar7 = getModdedStat(pCVar1->Stats,STAM);
      if ((short)iVar5 <= iVar7) {
        ...
        if ((int)uVar8 < iVar5) {
          ...
          iVar7 = getBaseStat(pCVar2->Stats,arg1);
          if (iVar7 < iVar5 + iVar10) {
            iVar7 = getBaseStat(pCVar2->Stats,arg1);
            iVar10 = (iVar7 - iVar5) * 0x10000 >> 0x10;
          }
...
byte potion_recipie_func_(PartyStruct *param_1,uint param_2,PotionEnum param_3)

{
  ...
  puVar2 = (undefined *)
           (((gGlobals.BigAssMenu)->widget).substruct)->dollmenu->field_0x88->field_0x94;
  iVar6 = get_potion_recipie((PotionEnum)((longlong)(char)param_3 & 0xffU));
  if (iVar6 != (potionRecipie *)0x0) {
    ...
    if (uVar9 < uVar12) {
      ...
      uVar10 = 0;
      if (iVar6->pad <= uVar4) {
        uVar4 = (longlong)(char)param_3 & 0xffU | 0x1000;
        piVar3 = param_1->Inventory->Functions;
        ...
        if (uVar10 != 0) {
          ...
          FUN_8002ff30(*(undefined4 *)(puVar2 + 0x80));
        }
      }
      goto LAB_80081538;
    }
...
float ranger_int_float(PartyStruct *param_1){ //used for calulating the reagent multiplier
  ...
  if ((cVar4 == -1) || (pCVar1 = param_1->Party[cVar4], pCVar1 == (CharSheet *)0x0)) {
    fVar5 = 0.0;}
  else {
    iVar2 = getModdedStat(pCVar1->Stats,INT);
    cVar4 = getModdedSkill(pCVar1->Skills,Ranger);
...
uint mechanic_check(PartyStruct *param_1,SkillEnum param_2,byte param_3){
  int iVar1;
  char cVar3;
  uint uVar2;
  uint uVar4;
...
s8 GetMostSkilledMember(PartyStruct *param_1,SkillEnum param_2){
...
bool get_ranger_camping_bool(PartyStruct *param_1){
  ...
  if (get_event_flag(0x138c) == false) {bVar3 = false;}
    ...
    if ((cVar4 != -1) {
      uVar6 = 0;
      if (param_1->Party[cVar4] != (CharSheet *)0x0) {
...
void multi_equip_StamMod(Temp_weapon *param_1,float param_2){
  ...
  if (((param_1 != (Temp_weapon *)0x0) && (pabVar1 = param_1->Stat, pabVar1 != (byte (*) [2])0x0))
     && ((*pabVar1)[0] == 5)) {
...
uint check_party_skill(PartyStruct *param_1,SkillEnum param_2){
  uint uVar1;
  uint uVar2;
...
uint get_best_stat(PartyStruct *param_1,StatEnum param_2){
  uint uVar1;
  CharSheet *piVar4;
  uint uVar3;
...
uint get_worst_stat(PartyStruct *param_1,StatEnum param_2){
  uint uVar1;
  CharSheet *piVar4;
  uint uVar3;
...
uint get_this_char_stat(PartyStruct *param_1,ItemID param_2,StatEnum param_3){
  uint i = 0;
  CharSheet *psVar1;
...

{
  ...
  iVar1 = 0;
  do {
    piVar5 = (CharSheet *)((int)param_1->Party + iVar1);
    if ((*(int *)piVar5 != 0) &&
       (iVar1 = getModdedStat(*(CharStats **)(*(int *)piVar5 + 0x18),INT), (int)uVar3 < iVar1)) {
      uVar3 = getModdedStat(*(CharStats **)(*(int *)piVar5 + 0x18),INT);
    }
    uVar5++;
    iVar1 = uVar5 << 2;
  } while (uVar5 < 4);
...
u8 get_ranger_or_warrior(PartyStruct *param_1,uint param_2){
  ...
  if (cVar2 == -1) {
    ...
    if (param_1->Party[0] == (CharSheet *)0x0) goto LAB_80082bf0;
    lVar4 = 0;
  }
...
bool FUN_80082e40(PartyStruct *param_1,int param_2,ItemID param_3){
  CharSheet *pCVar1;
  temp_armor *ptVar2;
  ItemID *pIVar3;
  CharGear *pCVar4;
  ...
  pCVar1 = param_1->Party[param_2];
  if (pCVar1 != (CharSheet *)0x0) {
    if (pCVar1->weapons == (Temp_weapon *)0x0) {ptVar2 = (temp_armor *)pCVar1->armor;}
    else {
    ...
    if (*(temp_armor **)ptVar2 == (temp_armor *)0x0) {
...
bool Ofunc_80082fcc(short *param_1,short param_2){
...
bool hasItem_eqquipped(PartyStruct *param_1,int param_2,ItemID param_3){
  ...
  if (param_1->Party[param_2] == (CharSheet *)0x0) {bVar2 = false;}
  else {
    pTVar1 = Has_Item_equipped_character(param_1->Party[param_2],param_3);
    bVar2 = pTVar1 != (Temp_weapon *)0x0;
  }
  return bVar2;
}
...
bool FUN_800830a4(PartyStruct *param_1,byte param_2,temp_gear *param_3,CharSheet *param_4,
                 byte param_5){
  ItemID IVar1;
  inv_funcs *piVar2;
  byte bVar4;
  ...
  bVar4 = FUN_8007e798(param_1,bVar4);
  if (bVar4 != 0) {
    return (bool)bVar4;
  }
  uVar8 = 0;
